...
#'
#' Calculate the implicit sigma that was used to calculate Xpa from Xlim.
#'
...
#'
#' @details The order of the parameters does not matter, so
#'          \code{sigmaPA(Fpa, Flim)} and \code{sigmaPA(Flim, Fpa)} are
#'          equivalent.
#'
#' @return Implicit value of sigma.
#'
#' @note Useful for reviewing PA reference points, when the advice sheet
#'       provides the value of Xlim and Xpa but not the value of sigma.
#'
...
#'
#' @seealso \code{\link{sigmaCI}} calculates the implicit sigma from a
#'          confidence interval.
#'
